...
public class aboutUs extends JFrame{
    ...
    public aboutUs() {
        ...
        super("Library Management System created by Chirag Reshi");
        ...
        JLabel l6 = new JLabel("Developed By : Chirag Reshi");
        l6.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
        l6.setBounds(70, 198, 600, 35);
        contentPane.add(l6);

        JLabel l7 = new JLabel("LinkedIn : chirag-reshi-295915169");
        l7.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
        l7.setBounds(70, 260, 600, 34);
        contentPane.add(l7);

        JLabel l8 = new JLabel("Github Link : github.com/Chirag-Reshi");
        l8.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
        l8.setBounds(70, 290, 600, 34);
        contentPane.add(l8);

        JLabel l9 = new JLabel("This project shows some basic implementation of Java Swing");
